...
public class DataChangesCsvTest {
    ...
    public void resultCurrentVersionDataHashcodeCodeChangesTest() throws IOException {
        ...
        List<ReportRow> testResultData = droolsBuildtimeJenkinsReport.getData(currentVersionBuildtimePath, SourceFileExtension.CSV, SourceFileLocation.WEB);
        testResultData.addAll(droolsRuntimeJenkinsReport.getData(currentVersionRuntimePath, SourceFileExtension.CSV, SourceFileLocation.WEB));
    ...
    public void resultPreviousVersionDataHashcodeCodeChangesTest() throws IOException {
        ...
        List values = new ArrayList();
        List<ReportRow> testResultData = droolsBuildtimeJenkinsReport.getData(previousVersionBuildtimePath, SourceFileExtension.CSV, SourceFileLocation.WEB);
        testResultData.addAll(droolsRuntimeJenkinsReport.getData(previousVersionRuntimePath, SourceFileExtension.CSV, SourceFileLocation.WEB));
    ...
    public void resultOlderVersionDataHashcodeCodeChangesTest() throws IOException {
        ...
        olderVersionBuildtimePath = GoogleDriveHelper.prepareGoogleDriveFile(driveService, DroolsSpreadsheetsToGenerate.BUILDTIME.getFileType(), olderVersionBuildtimePath, localDir, StaticVersion.OLDER, SourceFileExtension.CSV);
        olderVersionRuntimePath = GoogleDriveHelper.prepareGoogleDriveFile(driveService, DroolsSpreadsheetsToGenerate.RUNTIME.getFileType(), olderVersionRuntimePath, localDir, StaticVersion.OLDER, SourceFileExtension.CSV);
        ...
        testResultData.addAll(droolsRuntimeJenkinsReport.getData(olderVersionRuntimePath, SourceFileExtension.CSV, SourceFileLocation.LOCAL));
