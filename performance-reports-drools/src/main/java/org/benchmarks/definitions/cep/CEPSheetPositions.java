...
public final class CEPSheetPositions extends ReportSheetPositions {
    static {
    ...
    private static int getFirstKeyValue(){
        DMNSheetPositions dmnSheetPositions = new DMNSheetPositions();
        return getNextKeyValue(dmnSheetPositions.positions);
    }

    public CEPSheetPositions() {
    }
}
