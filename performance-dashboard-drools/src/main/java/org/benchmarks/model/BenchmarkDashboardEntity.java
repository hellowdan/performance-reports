...
//public class BenchmarkDashboardEntity {
//
//    @Id
...
//
//    public BenchmarkDashboardEntity() {
//    }
//
//    public BenchmarkDashboardEntity(String name, String fancyName, String numberOfRules, String nrOfRules, String useCanonicalModel, String rulesProviderId, String matchRatio, String score, ReportType reportType, StaticVersion staticVersion, String version) {
...
//        this.reportVersion = staticVersion.toString();
