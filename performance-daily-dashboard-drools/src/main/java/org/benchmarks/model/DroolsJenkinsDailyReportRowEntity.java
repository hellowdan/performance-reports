...
public class DroolsJenkinsDailyReportRowEntity {
    ...
    public DroolsJenkinsDailyReportRowEntity() {
    }

    public DroolsJenkinsDailyReportRowEntity(String job, String name, String score) {
